...
if __name__ == "__main__" :
    ...
    cancel_message_handler = MessageHandler(
        cancel_message_f,
        filters=filters.command([Commandi.CANCEL@torlecbot]) & filters.chat(chats=AUTH_CHANNEL)
    )
    ...
    save_thumb_nail_handler = MessageHandler(
        save_thumb_nail,
        filters=filters.command([Commandi.SAVETHUMBNAIL@torlecbot]) & filters.chat(chats=AUTH_CHANNEL)
    )
    ...
    clear_thumb_nail_handler = MessageHandler(
        clear_thumb_nail,
        filters=filters.command([Commandi.CLEARTHUMBNAIL@torlecbot]) & filters.chat(chats=AUTH_CHANNEL)
    )
